...
// это КРУГЛОСУТОЧНЫЙ запрет, действующий каждый день недели без исключений
// (не «по будням», это была ошибка в тексте до 07.09.2026 — см.
// TRUCK_BANS_EU/CLAUDE.md, раздел «Варшава: факт исправлен»), а не «запрет
// на сегодня» — поэтому не прячем его внутрь обычной карточки Польши и не
